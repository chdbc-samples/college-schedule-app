...
import com.library.entity.ScheduleInfoDTO;
import com.library.repository.ClassScheduleRepository;
...
public class ScheduleServiceTest {
    ...
    void setUp() {
        ...
        expectedJpql = "SELECT new com.library.entity.ScheduleInfoDTO(" +
